...
class TextStatics:
    ...
    def get_start_message(username: str):
        ...
        return _t('get_start_message', default, username=username)
    ...
    @staticmethod
    def need_choose_city() -> str:
        default = "Укажите город вашей команды или нажмите Пропустить"
        return _t('need_choose_city', default)
