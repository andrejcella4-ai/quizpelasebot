...
class TextStatics:
    ...
    @staticmethod
    def get_start_message_group_new(captain: str):
        default = (
            "👋 Всем привет!\n\n"
            "Я — официальный бот от Квиз, плиз! в Telegram 💥\n\n"
            "Могу устроить вам соревнование между собой и ежедневно задавать вам вопросы, как команде (да, все как в настоящем Квиз, плиз!)\n\n"
            "Прежде чем мы начнём — давайте познакомимся!\n\n"
            "📝 {captain}, напиши название команды вашего чата в ответ на это сообщение — и погнали! 💥"
        )
        return _t('start_message_group_new', default, captain=captain)
    ...
    def select_mode_message():
        ...
        return _t('select_mode_message', default)
